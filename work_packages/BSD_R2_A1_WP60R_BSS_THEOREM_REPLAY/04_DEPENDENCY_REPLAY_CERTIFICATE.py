...
provider anchor, retired boundary, and preserved claim firewalls machine-checkable.
"""
...
# remain part of the replay.  We check that WP60R does not erase it textually.
...
for dim in range(1, 7):
    ...
    for c in universe[1:]:
        ...
        # Any witness functional detecting c has codimension-one kernel.
        for f in witnesses:
