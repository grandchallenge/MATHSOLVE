...
- Protected integration base:
  `1bc91582eacef12359461a024549cd12c00969aa`
...
It proves a sufficient first-order packet-occupation interface.  The protected
L5-39 calibration shows specifically that the reciprocal-amplitude component
of that interface is not controlled by the existing coarse scalar budgets.
