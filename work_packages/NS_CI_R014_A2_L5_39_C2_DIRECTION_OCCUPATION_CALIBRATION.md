...
- Dependency status: protected merge exists; fresh protected-main replay is still
  pending at this pre-admission checkpoint.
- Result class: pre-admission exact calibration
- Proposed result:
