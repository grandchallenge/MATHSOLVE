...
| Rank-one free direction | saturated quotient `X_E/Tor(X_E) ~= Z_2` | replacing the saturated free line by the span of a nonprimitive point without its index | compute the exact index of any Heegner/Euler-system generator sublattice |
