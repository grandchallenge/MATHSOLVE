...
Original path: AvgRare/Secondary/MainStatement.lean
Initial transport changes: module import paths only. External source remains provenance;
this copy is compiled and reviewed inside MATHSOLVE before use.
-/

import MathSolve.UnionClosed.AvgRarePort.Functional.FuncSetup
import MathSolve.UnionClosed.AvgRarePort.Basics.SetFamily
import MathSolve.UnionClosed.AvgRarePort.Basics.SetTrace
import MathSolve.UnionClosed.AvgRarePort.Reductions.Reduction
import MathSolve.UnionClosed.AvgRarePort.Secondary.SumProduct
import MathSolve.UnionClosed.AvgRarePort.Secondary.UniqueMax
