# MATHSOLVE Domain: Union-Closed Sets

This domain contains Work Packages for Frankl's union-closed sets conjecture and related finite set-system problems.

Initial sequence:

- WP01: status spine and certification entry point.
