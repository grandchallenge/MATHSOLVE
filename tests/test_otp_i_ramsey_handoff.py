...
SPEC = importlib.util.spec_from_file_location("validate_otp_i_ramsey_handoff", ROOT / "ci/validate_otp_i_ramsey_handoff.py")
mod = importlib.util.module_from_spec(SPEC)
assert SPEC and SPEC.loader
SPEC.loader.exec_module(mod)


class IRamseyHandoffTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_reject_explicit_constant_source_inflation(self):
