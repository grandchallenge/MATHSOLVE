...
SPEC = importlib.util.spec_from_file_location("validate_otp_g_quantum_parallel_repetition_handoff", ROOT / "ci/validate_otp_g_quantum_parallel_repetition_handoff.py")
mod = importlib.util.module_from_spec(SPEC)
assert SPEC and SPEC.loader
SPEC.loader.exec_module(mod)


class GQuantumParallelRepetitionHandoffTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_reject_empty_answer_scope_inflation(self):
